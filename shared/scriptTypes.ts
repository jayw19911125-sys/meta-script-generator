...
export const GPT_MODELS = [
  { value: "gpt-5",       label: "GPT-5",       tier: "極耗成本慎選", costHint: "極高", recommend: "最強創意發散、Hook 多樣性最佳" },
  { value: "gpt-5-mini",  label: "GPT-5 Mini",  tier: "標準",         costHint: "中",   recommend: "日常首選，速度與品質平衡" },
...
export const CLAUDE_MODELS = [
  { value: "claude-opus-4-7",   label: "Claude Opus 4.7",   tier: "極耗成本慎選", costHint: "極高", recommend: "最強逿輯整合、長文說服力最佳" },
  { value: "claude-opus-4-6",   label: "Claude Opus 4.6",   tier: "極耗成本慎選", costHint: "高",   recommend: "高品質 Body+CTA，正式廣告素材" },
